...
function reveal() {
  ...
  document.querySelector('#video').appendChild(x);


  let mySound = new Audio('C:/Users/Yash.Koradiya/Downloads/Your Birthday/Birthday/Birthday/Assest/pic/Mere Mahi Jeena Sona - O Mere Mahiya Jinna Sona ! Hindi Song.mp3')
mySound.play()
